...
from offline_training_mec.rlkit.policies.base import Policy
from offline_training_mec.rlkit.torch import pytorch_util as ptu
from offline_training_mec.rlkit.torch.core import eval_np
from offline_training_mec.rlkit.torch.data_management.normalizer import TorchFixedNormalizer
from offline_training_mec.rlkit.torch.modules import LayerNorm
...
class PMOEMlp(nn.Module):
    def __init__(
        ...
        self.last_fc.weight.data.uniform_(-init_w, init_w)
        self.last_fc.bias.data.uniform_(-init_w, init_w)
        self.mixing_coefficient_fc = nn.Linear(in_size+goal_size, k)
